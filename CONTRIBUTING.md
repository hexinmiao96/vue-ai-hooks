...
Then create and push a tag matching `package.json`, for example `v1.0.0-rc.2`.
...
4. Create a tag that exactly matches the package version, for example `v1.0.0-rc.2`.
