...
| `inspect()`               | `() => RequestInspectionSnapshot<GenerationRequestInfo<TInput>, GenerationResponseInfo<TInput, TResult>>` | Build a production-ready debug snapshot with timeline and retry records. |
