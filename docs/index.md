...
features:
  - title: Eight composables, one mental model
    details: useChat, useCompletion, useEmbedding, useGeneration, useImage, useSpeech, useTranscription, and useObject cover chat, text, vectors, custom generation jobs, app-owned image, speech, and transcription routes, and structured JSON. Pluggable providers let you swap models without rewriting your app.
  ...
  - title: Consistent statuses
    details: status, isLoading, error, and clearError follow one lifecycle vocabulary across chat, completion, embedding, image generation, speech generation, transcription, custom generation, and structured object output.
