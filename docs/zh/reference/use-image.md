...
| 名称             | 类型                                                                   | 默认值       | 说明                                            |
| ---------------- | ---------------------------------------------------------------------- | ------------ | ----------------------------------------------- |
| `api`            | `string`                                                               | `/api/image` | 应用后端的图片生成 URL。                        |
...
| `defaultRequest` | `Partial<ImageGenerationRequest>`                                      | `{}`         | 默认图片生成选项。                              |
...
| `onFinish`       | `(result: ImageGenerationResult) => void`                              | -            | 图片生成成功时调用。                            |
...
- 后端请求 JSON 会包含 `prompt`、`model`、`n`、`size`、`aspectRatio`、`seed`、
