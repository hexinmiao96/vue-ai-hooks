...
| Thread 侧边栏持久化    | No-key chat 加本地 storage                         | [useChatThreads](/zh/reference/use-chat-threads)                    | 创建、重命名、归档、恢复并重新打开 thread       |
...
先验证 create、rename、archive、restore、delete，再接 server storage adapter。详见
