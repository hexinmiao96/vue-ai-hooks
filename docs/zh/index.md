...
features:
  ...
  - title: 一致的状态模型
    details: status、isLoading、error 和 clearError 在聊天、补全、向量、图片生成/编辑、语音生成、转写、自定义生成与结构化对象输出中使用同一套生命周期语义。
  - title: TypeScript 优先
