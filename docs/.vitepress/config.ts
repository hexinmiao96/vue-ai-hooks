  ...
  '/guide/': [
    {
      ...
      items: [
        ...
        { text: 'OSS adoption smoke', link: '/guide/oss-adoption-smoke' },
        { text: 'Adoption evidence', link: '/guide/adoption-evidence' },
  ...
  '/zh/guide/': [
    {
      ...
      items: [
        ...
        { text: '工具审批', link: '/zh/guide/tool-approvals' },
        { text: '后端 Agent 桥接', link: '/zh/guide/agent-bridge' },
        { text: 'Agent 路由模板', link: '/zh/guide/agent-route-templates' },
        ...
        { text: '采用和 1.0 准备', link: '/zh/guide/adoption-readiness' },
        { text: '已有应用 smoke', link: '/zh/guide/existing-app-adoption-smoke' },
        { text: 'OSS 接入 smoke', link: '/zh/guide/oss-adoption-smoke' },
        { text: '采用证据', link: '/zh/guide/adoption-evidence' },
