...
十五个可运行示例位于 [`examples/`](https://github.com/hexinmiao96/vue-ai-hooks/tree/main/examples)：
...
[服务端存储配方](https://github.com/hexinmiao96/vue-ai-hooks/blob/main/docs/zh/guide/server-storage.md)，并补齐 `revision`、`runId` 和 restore smoke test 的重新生成/分支冲突处理。功能规划放在
